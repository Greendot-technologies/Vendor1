...
//     { from: "", to: "", departDate: "", fromSuggestions: [], toSuggestions: [], showFromDropdown: false, showToDropdown: false },
//   ]);
...
//   const addCityPair = () => {
//     setCities([...cities, { from: "", to: "", departDate: "", fromSuggestions: [], toSuggestions: [], showFromDropdown: false, showToDropdown: false }]);
//   };
...
//           method: "GET",
//           headers: {
//             Authorization: `Bearer ${authData?.token}`, // Include token if required by backend
//           },
//         });
...
//           method: "GET",
//           headers: {
//             Authorization: `Bearer ${authData.token}`, // Include token
//           },
//         }
//       );
...
import debounce from "lodash/debounce";
import { useAuth } from "../context/AuthContext";
import HorizontalSearchForm from "../section/HorizontalSearchForm"; // Adjust the import path as needed
            ...
            {index === 0 && (
              <div className="flex border px-3 py-2 rounded-full items-center lg:w-full">
                <input
                  ...
                  className="w-full outline-none text-sm lg:text-base"
                  value={city.passengers}
                  min="1"
                  onChange={(e) => updateCityPair(index, "passengers", parseInt(e.target.value) || 1)}
                />
              </div>
            )}
          </div>
