...
//   if (!category_id || !name_en || !slug || !vendor_id) {
...
//       return res.status(400).json({
//         message: 'Invalid or inactive category_id',
//       });
//     }

//     // Proceed with inserting the subcategory
...
//        SET is_active = true, approved_by_admin = true
//        WHERE id = $1
//        RETURNING *`,
//       [id]
//     );
...
//     res.json({
//       message: 'Subcategory approved',
//       subcategory: result.rows[0],
//     });
//   } catch (err) {
//     res.status(500).json({
//       message: 'Error approving subcategory',
//       error: err.message,
//     });
//   }
// };
