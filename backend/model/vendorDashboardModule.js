...
//       'SELECT id, vendor_profile_id FROM pincodes WHERE id = $1 AND vendor_profile_id = $2',
//       [pincodeId, vendorProfileId]
//     );
//     if (pincodeCheck.rows.length === 0) {
//       throw new Error('Pincode not found or not associated with this vendor');
//     }
...
//   try {
//     const pincodeCheck = await pool.query(
//       'SELECT id FROM pincodes WHERE id = $1 AND vendor_profile_id = $2',
//       [pincodeId, vendorProfileId]
//     );
