...
//                   <input name="name_en" value={form.name_en} onChange={handleInput} placeholder="Name (EN)" className="border p-2 rounded" required />
//                   <input name="name_hi" value={form.name_hi} onChange={handleInput} placeholder="Name (HI)" className="border p-2 rounded" />
//                   <input name="category_id" value={form.category_id} onChange={handleInput} placeholder="Category ID" className="border p-2 rounded" />
//                   <input name="sub_category_id" value={form.sub_category_id} onChange={handleInput} placeholder="Subcategory ID" className="border p-2 rounded" />
//                   <input name="mrp" type="number" value={form.mrp} onChange={handleInput} placeholder="MRP" className="border p-2 rounded" />
//                   <input name="selling_price" type="number" value={form.selling_price} onChange={handleInput} placeholder="Selling Price" className="border p-2 rounded" />
//                   <input name="packaging" value={form.packaging} onChange={handleInput} placeholder="Packaging (e.g. 500gm)" className="border p-2 rounded" />
//                   <input name="stock_quantity" type="number" value={form.stock_quantity} onChange={handleInput} placeholder="Stock" className="border p-2 rounded" />
//                   <input name="primary_image_url" value={form.primary_image_url} onChange={handleInput} placeholder="Primary Image URL" className="border p-2 rounded" />
//                   <input name="images" type="file" multiple onChange={handleInput} className="border p-2 rounded" />
...
//             {products.map((prod) => (
//               <div key={prod.id} className="bg-white rounded shadow p-4 relative">
//                 <img
//                   src={prod.primary_image_url || (JSON.parse(prod.images || "[]")[0] || "")}
//                   alt=""
//                   className="h-40 w-full object-cover rounded"
//                 />
//                 <h4 className="mt-2 font-bold">{prod.name_en}</h4>
//                 <p className="text-sm">MRP: ₹{prod.mrp}</p>
//                 <p className="text-sm">Selling: ₹{prod.selling_price}</p>
//                 <div className="mt-3 flex justify-between">
//                   <button onClick={() => handleEdit(prod)} className="text-blue-600">
//                     Edit
//                   </button>
...
//     try {
//       const res = await axios.get("http://localhost:5000/api/user/approved");
...
//                   <select name="category_id" value={form.category_id} onChange={handleInput} className="border p-2 rounded" required>
...
//                   <select name="sub_category_id" value={form.sub_category_id} onChange={handleInput} className="border p-2 rounded" required>
...
//         // Optional: redirect to login page or clear tokens here
//       }
//     }
//   };
            ...
            <td className="px-6 py-4 border-r">
              <img
                src={parseProductImages(prod.images)[0]?.startsWith('http') 
                  ...
                  : `http://localhost:5000${parseProductImages(prod.images)[0]}`}
                alt="product"
