...
//             <SalesReport />
//             <div>
//               <h2 className="text-xl md:text-2xl font-semibold relative inline-block mb-4 ml-12">
//                 Top 5 TopAirlines
...
//             <div>
//               <div className="flex space-x-4 border-b-2 border-gray-200 mb-4 ml-12">
//                 <button
//                   onClick={() => setActiveTab("sales")}
//                   className={`pb-2 text-xl md:text-2xl font-semibold ${
//                     activeTab === "sales"
...
//             {/* Agent Info */}
//             <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200 lg:w-[20rem]">
